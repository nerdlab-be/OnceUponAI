      ...
      {locale !== "en" && (
        <li>
          <Link href={asPath} locale="en" onClick={() => changeLanguage("en")} >
            <Image alt="English" src="https://unpkg.com/language-icons/icons/en.svg" width={24} height={24} id="languageId"/>
          </Link>
        </li>
      )}
      {locale !== "nl" && (
        <li>
          <Link href={asPath} locale="nl" onClick={() => changeLanguage("nl")} >
            <Image alt="Dutch" src="https://unpkg.com/language-icons/icons/nl.svg" width={24} height={24} id="languageId"/>
          </Link>
        </li>
      )}
    </ul>
